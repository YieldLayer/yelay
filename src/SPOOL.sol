 ...
 */
contract SPOOL is ERC20Pausable, Ownable {
    uint256 private constant TOKEN_SUPPLY = 210_000_000 ether;

    /**
     * @dev Configures the token's name & symbol, sets the owner,
     * and mints the initial supply to the provided address.
     */
    constructor(address _owner, address _holder) ERC20Pausable() ERC20("Spool DAO Token", "SPOOL") {
